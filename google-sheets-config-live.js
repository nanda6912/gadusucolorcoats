// Google Sheets Configuration for Live GitHub Pages Deployment
const GOOGLE_SHEETS_CONFIG = {
    // For local development with proxy server
    PROXY_URL: 'http://localhost:3001/api/google-sheets',
    
    // For live GitHub Pages deployment (uncomment this)
    // PROXY_URL: 'https://gadusu-proxy.vercel.app/api/google-sheets',
    
    // Direct Google Apps Script URL (alternative to proxy)
